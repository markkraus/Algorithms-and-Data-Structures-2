...
public class BoggleSolver
{
	...
	// Checks if the new coordinates are on the board and we have not yet used the letter at the new coordinates
	private boolean isValid(int row, int col, int direction){
		...
		if((coords.row >= 0 && coords.row < 4) && (coords.col >= 0 && coords.col < 4)) {
			...
			Character character = theBoard[coords.row][coords.col];
