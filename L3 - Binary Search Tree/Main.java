public class Main {
  ...
  private <T extends Comparable<? super T>> void testPredecessor(BinarySearchTree<T> bst, T input) {
    System.out.println("Predecssor of " + input + " is " + bst.predecessor(input));
  }

  private <T extends Comparable<? super T>> void testSuccessor(BinarySearchTree<T> bst, T input) {
